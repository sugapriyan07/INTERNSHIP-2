...
This is a Quiz web application built with React + TypeScript, scaffolded with Vite. It provides functionality to create quizzes, take quizzes, and view results. The UI uses Tailwind CSS and Radix-inspired primitives.

Key features

- User authentication (see `src/pages/Auth.tsx`)
...
- View results and basic analytics (`src/pages/Results.tsx`)
